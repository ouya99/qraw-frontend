        ...
        >
          ...
          >
            <div className="flex justify-between items-center">
              <h2 className="text-white text-xl font-bold">Connect to Server</h2>
              <img
                src={CloseIcon}
                onClick={handleClose}
            ...
            {selectedMode === 'form' && (
              <div className="text-white mt-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  <button className="bg-primary-40 p-4 rounded-lg text-black" onClick={handleClose}>
                    Cancel
                  </button>
                  <button className="bg-primary-40 p-4 rounded-lg text-black" onClick={handleSave}>
                    Connect
                  </button>
                </div>
              </div>

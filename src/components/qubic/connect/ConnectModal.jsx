          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            {!connected && <>
              <button
                ...
                onClick={() => setSelectedMode('private-seed')}>Private Seed
              </button>
              <button
                className="bg-primary-40 p-4 rounded-lg"
                onClick={() => setSelectedMode('vault-file')}>Vault File
              </button>
              <button disabled
                      className="bg-gray-50 p-4 rounded-lg"
                      onClick={() => setSelectedMode('metamask')}>MetaMask (coming soon)
              </button>
            </>}
          </div>
        }
        ...
        {selectedMode === 'private-seed' &&
          <div className="text-white mt-4">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <button
                className="bg-primary-40 p-4 mt-4 rounded-lg text-black"
                onClick={() => setSelectedMode('none')}>Cancel
              </button>
              <button
                className="bg-primary-40 p-4 mt-4 rounded-lg text-black"
